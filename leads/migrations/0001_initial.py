    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone_nr', phone_field.models.PhoneField(blank=True, help_text='Contact phone number.', max_length=31)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sources', models.CharField(choices=[('Youtube', 'Youtube'), ('Google', 'Google'), ('Newsletter', 'Newsletter'), ('Linkedin', 'Linkedin'), ('Twitter', 'Twitter'), ('Other', 'Other')], max_length=128)),
